# From GitHub:  huggingface/timm/models/resnet.py
...
from timm.layers import (
    DropBlock2d, DropPath, AvgPool2dSame, BlurPool2d, LayerType, create_attn, # pyright: ignore[reportPrivateImportUsage]
    get_attn, get_act_layer, get_norm_layer, create_classifier, create_aa, to_ntuple  # pyright: ignore[reportPrivateImportUsage]
)
