# From GitHub:  huggingface/timm/models/swin_transformer.py
...
from timm.layers import (PatchEmbed, Mlp, DropPath, ClassifierHead, to_2tuple, to_ntuple, trunc_normal_,  # pyright: ignore[reportPrivateImportUsage]
    _assert, use_fused_attn, resize_rel_pos_bias_table, resample_patch_embed, ndgrid  # pyright: ignore[reportPrivateImportUsage]
)
